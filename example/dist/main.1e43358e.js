...
exports.imageBlurProcessing = imageBlurProcessing;
exports.imageBlurProcessing2 = imageBlurProcessing2;

function imageBlurProcessing(src, _ref) {
  var _ref$size = _ref.size,
      size = _ref$size === void 0 ? 1 : _ref$size,
      _ref$rect = _ref.rect,
      rect = _ref$rect === void 0 ? null : _ref$rect,
  ...
  return new Promise(function (resolve, reject) {
    image.onload = function () {
      var blurStartX = rect ? rect.left : 0;
      var blurStartY = rect ? rect.top : 0;
      var blurWidth = rect ? rect.width : image.width;
      var blurHeight = rect ? rect.height : image.height;
      var blurEndX = blurStartX + blurWidth;
      var blurEndY = blurStartY + blurHeight;
      ...
      var w = image.width * 4;
      imageData.data.forEach(function (_, i) {
        if (i % 4 == 0) {
          var y = parseInt(i / w);
          var x = i % w / 4;
          ...
          if ((y > blurStartY && y < blurEndY && x > blurStartX && x < blurEndX) != reverse) {
            ...
            for (var nx = x - size; nx < x + size + 1; nx++) {
              for (var ny = y - size; ny < y + size + 1; ny++) {
                var num = nx * 4 + ny * w;
...
function imageBlurProcessing2(src) {
  ...
  return new Promise(function (resolve, reject) {
    image.onload = function () {
      ...
      imageData.data.forEach(function (v, i) {
        rgba.push(v);
      ...
      console.log("ぼかし処理");
      startTime = Date.now();
      matrix.forEach(function (objX, x) {
        objX.forEach(function (_, y) {
          if (y > blurStartX && y < blurEndX && x > blurStartY && x < blurEndY) {
            ...
            for (var c = 0; c < 4; c++) {
              ...
              pixels.push(val / neighbors.length); //newImageData.data[((x * image.width) + y )  + c] = val / neighbors.length
            }
          } else {
            for (var _c = 0; _c < 4; _c++) {
              pixels.push(matrix[x][y][_c]); //newImageData.data[((x * image.width) + y )  + c] = matrix[x][y][c]
            }
          }
        });
      });
...
},{}],"assets/images/003.jpg":[function(require,module,exports) {
module.exports = "/003.493b31e9.jpg";
...
var image = require('../assets/images/003.jpg');
  ...
  methods: {
    ...
    blur: function blur() {
      ...
      setTimeout(function () {
        ...
        (0, _index.imageBlurProcessing)(src, options).then(function (res) {
          var endTime = new Date();
          _this.processTime = endTime - startTime;
          _this.isProcessing = false;
          _this.afterImage = res;
        });
      }.bind(this), "3");
    },
    onFileChang: function onFileChang(e) {
...
},{"../../index":"../index.js","moment":"node_modules/moment/moment.js","../assets/images/003.jpg":"assets/images/003.jpg"}],"../../../../../../../.config/yarn/global/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
